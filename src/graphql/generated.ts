...
export type CreateSusbscriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSusbscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSusbscriberDocument = gql`
    mutation CreateSusbscriber($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreateSusbscriberMutationFn = Apollo.MutationFunction<CreateSusbscriberMutation, CreateSusbscriberMutationVariables>;

/**
 * __useCreateSusbscriberMutation__
 *
 * To run a mutation, you first call `useCreateSusbscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSusbscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSusbscriberMutation, { data, loading, error }] = useCreateSusbscriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSusbscriberMutation(baseOptions?: Apollo.MutationHookOptions<CreateSusbscriberMutation, CreateSusbscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSusbscriberMutation, CreateSusbscriberMutationVariables>(CreateSusbscriberDocument, options);
      }
export type CreateSusbscriberMutationHookResult = ReturnType<typeof useCreateSusbscriberMutation>;
export type CreateSusbscriberMutationResult = Apollo.MutationResult<CreateSusbscriberMutation>;
export type CreateSusbscriberMutationOptions = Apollo.BaseMutationOptions<CreateSusbscriberMutation, CreateSusbscriberMutationVariables>;
